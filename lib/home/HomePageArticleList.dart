...
class HomePageArticleList extends StatefulWidget {
  @override
  _HomePageArticleListState createState() => _HomePageArticleListState();
}

class _HomePageArticleListState extends State<HomePageArticleList> {
  List<DataListBean> bannerDataList = [];
  int bannerLength = 0;

  List<Datas> entitiyList = [];
